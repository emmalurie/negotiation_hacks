...
Google Cloud Key Management Service lets you manage encryption for your cloud
services the same way you do on-premise. You can generate, use, rotate, and
destroy AES256 key encryption keys.
"""
